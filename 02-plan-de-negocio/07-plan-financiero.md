...
**Total previsto: ≈ 20.000 €** (aportación de Rubén; ampliable si fuese necesario).
...
| Fondo de maniobra (tesorería entre cobros y rampa inicial) | `[PENDIENTE]` | Con las puertas de contratación de Rubén (sin grupo parado) y los precios recalibrados, **los 20.000 € sobran**: caso tipo con caja mínima ≈ 6.500 € en feb-27 y siempre positiva (tesorería §7) |
| Marketing de arranque | **500–800 €/mes** (punto medio 650) | Decidido (D-0003, 2026-09-03), autogestionado. Ver sección 05 y [presupuesto](../04-finanzas/presupuesto-marketing-captacion-2027.md) |

## 2. Costes de mano de obra (2026 — método corregido por Rubén)

> ⚠️ CotizaT es el **generador comercial** (precios de venta): su propia base marca la
> hora de oficial a 21 € como *"tarifa facturada, no incluye cargas del empleador"*.
> **No se usa para calcular costes internos de personal.** El coste real se calcula
> desde el **convenio de la construcción de A Coruña 2026 + Seguridad Social 2026**
> (ficha completa: [coste-laboral-real-empleados-2026.md](../04-finanzas/coste-laboral-real-empleados-2026.md)):

| Perfil | Bruto/mes (14 pagas) | Coste empresa/año | Coste empresa/mes | €/h productiva |
|---|---|---|---|---|
| Ayudante de oficio (Niv. X) | 1.557 € | 28.991–29.940 € | 2.416–2.495 € | 16,6–17,1 |
| Oficial 1ª (Niv. VIII) | 1.632 € | 30.388–31.382 € | 2.532–2.615 € | 17,3–17,9 |
| **Grupo (1+1)** | — | **59.379–61.321 €** | **4.948–5.110 €** (medio 5.030) | ~34–35 €/h dúo |

- SS empresa 2026 ≈ 30,65 % (CC 23,60 + desempleo 5,50 + FOGASA 0,20 + FP 0,60 + MEI
  0,75) + AT/EP 2,35 % (CNAE 43) o 6,70 % (CNAE 41/construcción general).
- Jornada de referencia 1.752 h/año (a confirmar la del convenio). Salarios de convenio
  muy comprimidos: el ayudante cuesta casi lo mismo por hora que el oficial.
- **Uso:** calcular el coste de la obra tipo con **plantilla propia**: horas reales de
  los descompuestos de CotizaT (solo rendimientos) × coste/hora real de esta tabla.
  La tarifa de mercado de CotizaT (oficial 21 €/h, electricista 24 €/h, etc.) queda solo
  como referencia de precio de venta si algún día se subcontratase (no es el plan).
- `[PENDIENTE]`: CNAE/AT-EP con la gestoría, pluses del convenio y jornada → recalibrar
  con la primera nómina.
...
> Rubén; **recalibración de precios validada por Rubén** — ver
> [datos-confirmados](datos-confirmados.md) 17.ª tanda).
...
| Objetivo de obras/facturación año 1 | Caso tipo con grupos por cartera y precios de mercado: **≈ 299 k€ s/IVA** (38 pequeñas + 2 pisos 100 en cadena, ≈ +72.000 € antes de impuestos) — §5.2 y [tesorería §7](../04-finanzas/tesoreria-arranque-2026-2027.md) |
...
| Punto de equilibrio mensual | Sin grupo: ≈ 0,9 obra pequeña/mes (3.110 €/mes). **Con Grupo 1: ≈ 2,3 obras/mes (estructura ≈ 8.140 €/mes; cada pequeña ≈ 3.500 €)** — [tesorería v4](../04-finanzas/tesoreria-arranque-2026-2027.md) |
| IVA / IRPF / Impuesto de Sociedades | Según forma S.L. → con gestoría. IVA de reformas: **10 %** si se cumplen los 3 requisitos del art. 91.Uno.2.10º LIVA (uso particular, > 2 años, materiales ≤ 40 %), **21 %** en el resto — [ficha](../05-legal-y-tramites/fiscal/iva-reformas-10-vs-21.md) |
...
de obra: ≈ **3.110 €/mes** (1.210 fijos + ≈ 1.900 retribución). **Con el Grupo 1 contratado
(oficial + ayudante; coste real de convenio A Coruña + SS ≈ 5.030 €/mes, rango
4.948–5.110): ≈ 8.140 €/mes** → ver [tesorería v4](../04-finanzas/tesoreria-arranque-2026-2027.md)
...
> cadena → venta ≈ 299.200 € s/IVA, resultado ≈ + 71.900 € antes de impuestos**, caja
> siempre positiva (mínima ≈ 6.500 € en feb-27, final ≈ 78.000 € con los 20.000 € de
...
|---|---|---|---|---|
| Grupo 1 a 3 pequeñas/mes | 3/mes | ≈ 195 k€ | **+ 2.411 €/mes** | Con precios de mercado incluso un mes a 3 obras es positivo |
| Equilibrio del Grupo 1 | ≈ 2,3/mes | ≈ 150 k€ | ≈ 0 | Estructura ≈ 8.140 €/mes cubierta |
| **Caso tipo año 1 (objetivo)** | 38 pequeñas + 2 pisos 100 en cadena | **≈ 299 k€ s/IVA** | **≈ + 72.000 €** | G1 desde mar (puerta: 3+ firmadas); G2 contratado por obra durante cada grande; caja mín ≈ 6.500 € |
...
- Aportación propia ≈ 20.000 € (confirmada). Sin financiación externa prevista a día de hoy
  (revisar si el plan lo requiere). `[PENDIENTE]` de confirmar.
...
- [ ] **Cerrar régimen objetivo** con las [puertas de contratación](../04-finanzas/tesoreria-arranque-2026-2027.md)
      ...
      **2 grupos en cadena** ≈ +10.000 €/mes cuando ambos rinden → caso tipo año 1
      ≈ **+71.900 €** antes de impuestos. Confirmar modalidad de contratación y
...
- [x] **Recalibración de precios validada por Rubén (2026-09-03)** (bandas 2026 →
      ...
      el **tipo de IVA (10 % vs 21 %)** con la gestoría (criterio ya documentado en
      [`05-legal-y-tramites/fiscal`](../05-legal-y-tramites/fiscal/iva-reformas-10-vs-21.md)).
- [x] Montar **hoja de tesorería mensual de arranque** (dic-26 → dic-27) → v4 con modelo
      ...
      (§7): estructura ≈ 8.140 €/mes con Grupo 1; equilibrio ≈ 2,3 pequeñas/mes;
      caja mínima ≈ 6.500 €, final ≈ 78.000 €.
